...
import type { MutationMapper, QueryMapper } from "@/api/mappers"
...
export class HookFactory {
   ...
   */
  static createMappedMutationHook<
  ...
  >(
    ...
    mapper: MutationMapper<FrontendRequest, BackendRequest, BackendResponse, FrontendResponse>
  ) {
